...
class NavigationAddOnTest : KoinTest {
    @get:Rule
    val koinTestRule =
        KoinTestRule.create {
            modules(
    ...
    fun `WHEN add on generate assets then it return the correct assets`() {
        // Given
        val addOn by inject<NavigationAddOn>()
        addOn.initialize("com.theodo.apps.kuik")

        // When
        val assets = addOn.generateAssets(get(), get())
        ...
        assertListEquals(
            expected =
                listOf(
                    "src/commonMain/kotlin/com/theodo/apps/kuik/core/navigation/MainDestination.kt",
                    "src/commonMain/kotlin/com/theodo/apps/kuik/core/navigation",
                    "src/commonMain/kotlin/com/theodo/apps/kuik/core/navigation/di/navigationKoinModule.kt",
                    "src/androidMain/kotlin/com/theodo/apps/kuik/core/navigation",
                    "src/iosMain/kotlin/com/theodo/apps/kuik/core/navigation",
                    "build.gradle.kts",
                ),
